...
var exitLogin = require('./exitLogin')
...
var saveMsgList = require('./saveMsgList')
var getMsgList = require('./getMsgList')

router.post('/login', login)
router.post('/register', register)
router.post('/exitLogin', exitLogin)
router.post('/*', filter)
...
router.post('/saveMsgList', saveMsgList)
router.post('/getMsgList', getMsgList)
